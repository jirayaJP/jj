...
export class PetController {
  ...
  @Post()
  async addPet(
    @Body('PetName') prodName: string,
    @Body('PetBreed') prodBreed: string,
    @Body('PetGender') prodGender: string,
  ...
  async updatePet(
    ...
    await this.petService.updatePet(prodId, prodName, prodBreed, prodGender, prodPetPicURL, prodPetStatus, prodPetWeight,prodPetSize,prodPetColor, prodPetCerURL, prodPetLocation,prodPetDescription);
    return null;
  }
