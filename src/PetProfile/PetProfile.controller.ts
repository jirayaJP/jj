...
export class PetController {
  ...
  async addPet(
    ...
    @Body('PetWeight') prodPetWeight: string,
  ...
  async updatePet(
    ...
    await this.petService.updatePet(prodId, prodTitle, prodDesc, prodPrice, prodPetPicURL, prodPetStatus, prodPetWeight, prodPetCerURL);
    return null;
  }
